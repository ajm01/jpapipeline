...
public class DatabaseIT {
	...
	public void testGetAllPeople() {
		...
		assertTrue(allPeople.contains(expected1), "Did not find person " + expected1.name + " in all people: " + allPeople);
		assertTrue(allPeople.contains(expected2), "Did not find person " + expected2.name + " in all people: " + allPeople);
